...
const restaurants = [
  {
    ...
    description: "Authentic Thai cuisine with modern presentation in the heart of Bangkok."
  },
  {
    id: 2,
    name: "Urban Bistro",
    ...
    description: "Upscale international dining with premium ingredients and exceptional service."
  },
  {
    id: 3,
    name: "Noodle House",
    ...
    description: "Fast-casual Asian noodles and rice bowls with authentic flavors."
  },
  {
    id: 4,
    name: "Cafe Central",
    ...
    description: "Premium coffee and light bites in the heart of Bangkok's business district."
  }
];
...
app.post('/api/auth/register', async (req, res) => {
  try {
    const { email, password, firstName, lastName, phone, role = 'restaurant_owner' } = req.body;
...
app.put('/api/auth/profile', authenticateToken, (req, res) => {
  try {
    ...
    if (updates.profile) {
      mockUsers[userIndex].profile = { ...mockUsers[userIndex].profile, ...updates.profile };
    }
    if (updates.name) {
...
app.get('/api/restaurants', (req, res) => {
  const { cuisine, price_range, min_rating, limit = 10, offset = 0 } = req.query;
