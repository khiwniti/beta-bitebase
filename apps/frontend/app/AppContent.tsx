...
export default function AppContent({
  ...
  const restaurantName = (user as any)?.restaurantName || user?.displayName || user?.name || "Bella Vista Bistro"
  const userName = user?.displayName || user?.name || user?.email?.split('@')[0] || "Maria Rodriguez"
